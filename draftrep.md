...
style="width:4.61765in;height:2.59736in" />
...
systemic toxicity data.<sup>14</sup>
...
also contribute towards animal welfare.<sup>15</sup>
...
2034, accelerating at a CAGR of 18.7% from 2025 to 2034.<sup>1</sup>
...
trials by EMA and FDA guidelines<sup>4</sup>
...
guidelines for a better 3Rs framework: <sup>4</sup>
...
> non-clinical data on a case-by-case basis. <sup>5</sup>
>
...
<td style="text-align: left;"><p>In the event that no specific in vivo
...
animals based on evidence in literature, on a case by case basis</p>
<p>(10.2.1.4)</p></td>
...
<td style="text-align: left;"><p>10.2.2.3. Pharmacokinetics,
...
animal models, preferably including both small and large animals”.</p>
<p>10.2.1.5. For a GTP that is under pre-clinical evaluation for a first
in clinical use, a tiered preclinical testing paradigm involving
different assays for efficacy / toxicity documentation and both small
and large animal models (if available) should be employed to
characterize the functional attributes of the GTP.</p></td>
...
<td style="text-align: left;"><p>If there are differences between the
preclinical and clinical vectors, or</p>
<p>their production process,Additional toxicity studies pertaining to
clinical grade vectors may be required.</p>
<p>(10.2.5.2)</p></td>
...
like the Draize skin irritation assay<sup>1</sup>. 
...
toxicity and disease-specific responses <sup>2</sup>. The translational
...
cannot accurately predict human responses <sup>3</sup>. There is a
...
results in failure of clinical trials <sup>4</sup>, <sup>5</sup> . These
...
and actions<sup>6</sup>, <sup>7</sup>.
...
alternatives to traditional animal testing <sup>8</sup>.NAMs leverage
...
release like IL-6, IL-8, IL-1α <sup>11</sup>. In a study by Kojima et al
...
between different laboratories<sup>12</sup>. Similarly, the skin
...
439 <sup>13</sup>.Since the RhE closely mimics the histological,
...
<tr>
<td rowspan="8" style="text-align: left;"><p>Skin sensitization
studies</p>
<table>
<colgroup>
<col style="width: 66%" />
...
dermatomed skin, </td>
<td style="text-align: left;"><p>in-vitro skin tissues-2D;</p>
...
<td rowspan="7" style="text-align: left;">Photo toxicity testing</td>
<td rowspan="7" style="text-align: left;"><p>ICH guideline S10:</p>
...
guidelines include the FDA Guidance on In Vitro Methods<sup>16.</sup>.
...
into clinical studies <sup>20</sup>.InSphero, another company working in
...
be used to test the efficacy of antifibrotic compounds <sup>18</sup>.
...
microtissues<sup>19</sup>. These studies indicate that these advanced
...
<td rowspan="14" style="text-align: left;"><p>Detection of DILI: 1)
Albumin production rate, urea synthesis rate 2) Alanine aminotransferase
(ALT), Lactate dehydrogenase (LDH) activity</p>
...
<tr>
<td rowspan="4" style="text-align: left;"><p>Ultra structural
pathology,</p>
...
hLiMTs</td>
<td style="text-align: left;"><p>Primary Human -2D</p>
<p>hLiMTs-3D</p></td>
...
it can be used to predict human nephrotoxicity<sup>23</sup> . Another
...
<sup>24</sup>. Somova et al in 2024 developed a renal cell carcinoma
...
<tr>
<td style="text-align: left;"><p>human telomerized cells from different
tissues and organs (e.g., Kidney)</p>
...
toxicity during non-clinical studies<sup>22</sup>.
...
drugs and xenobiotics characterization<sup>27</sup>. Another study
...
study respiratory disease pathologies<sup>28</sup>. Burla et al in 2024
showed that ALIsens<sup>® </sup> from Invitrolize (3D alveolar model)
...
marker as a biomarker for predicting respiratory hazards<sup>29</sup>.
...
respond similarly to drugs<sup>30</sup>. Lung-on-chip from Emulate Bio
...
therapeutics and prophylactics <sup>31</sup>. These various studies
...
include ICH S7A<sup>22</sup> and OECD TG 426 which provides guidelines
...
accumulation of phospho α-Syn protein<sup>37</sup>. A number of studies
...
testing</td>
<td rowspan="19" style="text-align: left;"><p>Neurodevelopmental process
at cellular level:</p>
...
<td style="text-align: left;"><p>Organised individual neurons- 2D,</p>
...
microglia</td>
<td style="text-align: left;"><p>neural spheroids- 3D,</p>
...
early hazard identification<sup>22</sup>,<sup>43</sup>. An  initiative
...
reliability of non-animal testing approaches<sup>44</sup>.
...
<sup>45</sup>. In 2020, Błyszczuk et al conducted a study using
inSPhero’s 3D cardiac microtissues to model cardiac
fibrosis<sup>46</sup>. Another global player,Ncardia in January 2025
...
<td rowspan="15" style="text-align: left;"><p>Delayed ventricular
potential (pro-arythmia risk) measured via the following: 1) Ionic
currents in cardiomyocytes</p>
...
interval). </p></td>
<td rowspan="15" style="text-align: left;"><p>1. ICH S7A</p>
<p>2. ICH S7B</p></td>
...
non-clinical studies<sup>22</sup>. Some of the key industry-players in
...
<sup>51</sup>. Ozkan et al, 2024 used colon-on-chip from Emulate Bio to
...
female hormones on IBD syndrome<sup>52</sup>. Another study by Simon et
...
Lifesciences <sup>53</sup>.These studies proved that these alternative
...
Corneal Epithelium <sup>57</sup>. In another study conducted by Kaluzhny
et al in 2015, tested the effect of solid compounds on eye treated at
different time points from 90 mins to 6 hours<sup>58</sup>. Lubrun labs
...
classification systems <sup>59</sup>.Therefore, these technologies can
...
style="width:2.84722in;height:2.8125in" />  
...
<td colspan="3" style="text-align: left;"><p>Efficacy testing</p>
...
al</em> 2022</a> <sup><u>60</u></sup></td>
</tr>
<tr>
...
<td colspan="3" style="text-align: left;"><p>Extension of pharmaceutical
approval</p>
...
<td colspan="2" style="text-align: left;"><p>ClinicalTrials.gov ID/</p>
<p>EudraCT Number</p></td>
...
use<sup>63</sup>. While the approaches of reduction and refinement have
...
animal based research <sup>64</sup>. The US FDA modernization act passed
...
<sup>65</sup>, <sup>66</sup>, optimization of formulation to achieve
...
greater extent <sup>67</sup>, <sup>68</sup>. Regulatory agencies such as
US FDA <sup>69</sup>, and EMA<sup>70</sup> now have dedicated guidance
...
and translational capabilities<sup>71</sup>, human based computational
models were reported. In silico approaches combining computational and
experimental methods<sup>72</sup> can be used to predict clinical risk
...
<sup>73</sup> can predict the prolongation of QT interval that can lead
...
exhibiting such risk patterns<sup>74</sup>. Similarly, computational
models also have been reported in the literature for prediction of
efficacy (e.g. in the field of Cancer)<sup>75</sup> based on molecular,
...
(POC) studies when applied from early preclinical stage<sup>76</sup> .
...
requirement of preclinical studies<sup>77</sup>. 
...
principles<sup>78</sup>. OECD guidelines support invitro methods for
...
in 2019\[SK1\] )<sup>70</sup>, which talks about submitting PBPK models
...
intended application. Recently (Feb 2025), EMA<sup>79</sup> \[SK2\] also
...
2\[SK3\] 020<sup>69</sup> focusses on general recommendations regarding
...
)<sup>80</sup> has also been issued that details the requirements of
...
<tr>
<td style="text-align: left;">S1A, B, C<br />
CPMP/SWP/2877/00<br />
CHMP/SWP/2592/02<br />
CPMP/SWP/372/0</td>
...
<td style="text-align: left;">Toxicokinetic and pharmacokinetics,<br />
and biodistribution</td>
</tr>
<tr>
<td style="text-align: left;">S4, S6, S9<br />
CPMP/SWP/1042/99</td>
<td style="text-align: left;">Chronic toxicity</td>
</tr>
<tr>
<td style="text-align: left;">S5<br />
EMEA/CHMP/SWP/169215/2005<br />
CPMP/SWP/2600/01, EMEA/273974/2005 </td>
<td style="text-align: left;">Reproduction toxicity (fertility and<br />
developmental toxicity)</td>
</tr>
<tr>
<td style="text-align: left;">S7A</td>
<td style="text-align: left;">Cardiac toxicity, neurotoxicity,<br />
...
<tr>
<td style="text-align: left;">EMEA/CHMP/SWP/150115/2006<br />
(reflection paper)</td>
...
frameworks for using in silico data in drug evaluations<sup>81</sup>.
...
<td style="text-align: left;"><p>Conduct case studies to  analyse the
reason behind the failure of previous cell repository initiatives in
India</p>
<p>Setting up well-defined protocols for cell culture and cell
handling</p>
<p>Comprehensive training of individuals on proper cell culture SOPs to
maintain and freeze the cell lines according to proper protocol</p>
<p> Work in collaboration with stakeholders with expertise in this
area</p></td>
</tr>
<tr>
<td style="text-align: left;">Indigenous production of media components,
...
<td style="text-align: left;">Pharmaceutical companies, Academic
institutions, CROs</td>
<td style="text-align: left;"><p>Comprehensive training of individuals
to produce the media, and cell culture products.</p>
<p>Work in collaboration with stakeholders with expertise in this
area.</p></td>
</tr>
<tr>
...
<td style="text-align: left;">Pharmaceutical companies, Academic
institutions, CROs</td>
<td style="text-align: left;"><p>Use of these tools in the regulatory
...
preclinical or clinical study based on the outcome.</p>
<p>Collaborating with the DCGI to utilize legacy drug data for creating
in-silico tools to predict drug toxicity.</p>
<p>Focus on the Indigenous development of software for predicting
...
test was never formally validated<sup>1</sup>, it is still viewed as the
...
<sup>2,3</sup>. In the LAL test, contact with endotoxins can trigger a
...
β-D-glucan<sup>4,5</sup>. The horshoeshoe crab blood based lysate also
shows high batch-to-batch variability to due to variation found in the
natural lysate<sup>6</sup> In addition, the capture and bleeding
...
activity, speed and haemocyanin levels<sup>7</sup>. 
...
<td style="text-align: left;"><p>Parental pharmaceuticals </p>
<p> </p>
<p>Fluids in general </p></td>
<td style="text-align: left;"><p>Parental pharmaceuticals </p>
<p> </p>
<p>Fluids in general </p></td>
<td style="text-align: left;"><p>Parental pharmaceuticals </p>
...
<td style="text-align: left;"><p>Parental pharmaceuticals </p>
<p> </p>
<p>Fluids in general </p>
<p> </p>
<p>Surfaces of materials </p>
<p> </p>
<p>Aerosols </p></td>
</tr>
<tr>
...
<td style="text-align: left;"><p>Endotoxin-specific </p>
<p> </p>
<p>High sensitivity </p>
<p> </p>
<p>Technically simple </p></td>
<td style="text-align: left;"><p>Endotoxin-specific </p>
<p> </p>
<p>Very high sensitively </p>
<p> </p>
<p>Wide dynamic range </p></td>
<td style="text-align: left;"><p>Endotoxin-specific </p>
<p> </p>
<p>Very high sensitively </p>
<p> </p>
...
<p> </p>
<p>No interference by glucans </p>
<p> </p>
<p>No animal source </p>
<p> </p>
<p>Low batch-to-batch variation </p></td>
<td style="text-align: left;"><p>All pyrogens </p>
<p> </p>
<p>Human-specific  </p>
<p> </p>
<p>High sensitivity </p>
<p> </p>
<p>Fluids and materials testing </p>
<p> </p>
<p>Full animal replacement </p></td>
</tr>
<tr>
<td style="text-align: left;">Limitations </td>
<td style="text-align: left;">Animal-based </td>
<td style="text-align: left;"><p>Only for endotoxins and glucans </p>
<p> </p>
<p>Animal material required </p>
<p> </p>
<p>Batch-to-batch variability may be present </p></td>
<td style="text-align: left;"><p>Only for endotoxins and glucans </p>
<p> </p>
<p>Animal material required </p>
<p> </p>
<p> </p></td>
<td style="text-align: left;"><p>Only for endotoxins </p>
<p> </p>
<p>Liquid samples </p></td>
<td style="text-align: left;"><p>Availability of human blood </p>
<p> </p>
<p>Cryoblood cold chain </p>
<p> </p>
<p>Variation in human cell lines </p>
<p> </p>
<p>Interference from immunogenic drug substances </p></td>
</tr>
</tbody>
</table>
...
<img src="./media/image15.png" style="width:6.26806in;height:2.14514in"
alt="A white and grey table with black text Description automatically generated" /> 
...
<thead>
<tr>
<th colspan="3" style="text-align: left;"><p> </p>
<p>MONOCYTE ACTIVATION TEST </p>
<p> </p></th>
</tr>
</thead>
<tbody>
...
<td style="text-align: left;"><p>Ph. Eur. 2.6.30 Monocyte Activation
Test Chapter added in 2009 </p>
<p> </p>
<p>EDQM <a
...
assessment provided in the chapter to control pyrogenicity. </p>
<p> </p>
<p>The revised texts omitting the RPT and the new chapter, Pyrogenicity
(5.1.13), will be published in Supplement 11.8 of the Ph. Eur., with an
implementation date of 1 July 2025. </p>
<p> </p>
<p> </p>
<p> </p>
<p> </p></td>
...
<td style="text-align: left;"><p>General chapter on the  </p>
<p>Monocyte Activation Test added in the Introduction of Alternate Test
Methods Alternative </p></td>
</tr>
<tr>
<td colspan="3" style="text-align: left;"><p> </p>
<p>Recombinant Factor C </p>
<p> </p></td>
</tr>
<tr>
<td style="text-align: left;">FDA </td>
<td style="text-align: left;">Accepted as Compendial </td>
<td style="text-align: left;"><p>Guidance for industry, Pyrogen and
...
and accepts</a> the use of rFC to replace LAL. </p>
<p> </p>
<p>“If a manufacturer chooses to use a recombinant factor C-based assay,
...
&lt;1225&gt;, Validation of Compendial Procedures.” </p></td>
</tr>
<tr>
<td style="text-align: left;">US Pharmacopeia </td>
<td style="text-align: left;">Accepted as Alternative </td>
<td style="text-align: left;"><p>USP &lt;1085.1&gt; Use of Recombinant
Reagents in Bacterial Endotoxins Test on hold (Jun 2021) </p>
<p> </p>
<p>SP &lt;1223&gt; Validation of Alternative Microbiological
Methods </p>
<p> </p>
<p><a
...
Recombinant Reagennts </p>
<p> </p>
<p> </p></td>
</tr>
<tr>
<td style="text-align: left;"><p>European Pharmacopoeia  </p>
<p>EDQM </p></td>
<td style="text-align: left;">Accepted as Compendial </td>
<td style="text-align: left;"><p>Ph. Eur. 5.1.10 Guidelines for using
the test for bacterial endotoxins </p>
<p> </p>
<p>Inclusion of rFC in the monographs: </p>
<p>Water, purified (0008) </p>
<p>Water for injections (0169)  </p>
<p>Gene Therapy </p>
<p>Human Use </p></td>
</tr>
<tr>
...
Endotoxins</a>  </p>
<p><a href="https://www.pmda.go.jp/files/000231653.pdf">Test &amp;
Alternative Methods using</a>  </p>
<p><a href="https://www.pmda.go.jp/files/000231653.pdf">Recombinant
Protein-reagents for</a>  </p>
<p><a href="https://www.pmda.go.jp/files/000231653.pdf">Endotoxin
Assay</a>  </p></td>
</tr>
<tr>
<td style="text-align: left;">Korean Pharmacopoeia </td>
<td style="text-align: left;">Accepted as Compendial </td>
<td style="text-align: left;"><p>2022 completed a comparison study  </p>
<p>rFC vs. LAL and confirmed to  </p>
<p>become part of the KP in 2023 </p></td>
</tr>
<tr>
<td style="text-align: left;"><p> </p>
<p>Chinese Pharmacopoeia </p></td>
<td style="text-align: left;"><p> </p>
<p> </p>
<p>Accepted as Alternative </p></td>
<td style="text-align: left;"><p> </p>
<p> </p>
<p>ChP 1143 Bacterial </p>
<p>Endotoxins Test </p>
<p> </p>
<p>ChP 9251 Guideline for  </p>
<p>BET Application  </p>
<p>(introduction of the rFC) </p>
<p> </p></td>
</tr>
</tbody>
</table>
...
 <img src="./media/image16.png" style="width:5.46528in;height:3.25694in"
alt="A diagram of a timeline Description automatically generated with medium confidence" /> 
...
<td style="text-align: left;"><p>Young Scientist (DST-SYST), Toxicology
Division, Bio-Medical Technology wing </p>
<p>Sree Chitra Tirunal Institute for Medical Science and Technology
(SCTIMST), </p>
<p>Trivandrum </p>
<p> </p></td>
</tr>
...
<img src="./media/image17.png" style="width:3.50694in;height:2.77778in"
alt="A chart of different colored squares AI-generated content may be incorrect." /> 
...
<img src="./media/image18.png" style="width:5.40972in;height:2.72222in"
alt="A white grid with green dots and black text Description automatically generated" /> 
...
India<sup>1</sup>, whereas, the indigenous manufacturers perform wide
...
<img src="./media/image19.png" style="width:5.5625in;height:4.70833in"
alt="A graph of a number of companies Description automatically generated with medium confidence" /> 
...
has been established </p>
<p> </p>
<p>Still retained in the <em>General Chapter for Vaccines and
...
as Compendial by WHO</a>.  </p>
<p> </p>
<p>While current WHO Recommendations also include a test for specific
...
href="https://cdn.who.int/media/docs/default-source/biologicals/call-for-comments/who-guideline-on-3rs---draft-1-version-29-nov-2024-pc_clean.pdf?sfvrsn=7809e18d_1">Ref</a>). </p>
<p> </p></td>
</tr>
<tr>
<td style="text-align: left;"><p><em>Bulk purified toxoid </em> </p>
<p> </p></td>
<td style="text-align: left;"> </td>
<td style="text-align: left;"> </td>
<td style="text-align: left;"> </td>
...
<tr>
<td style="text-align: left;"><p>Absence of tetanus toxin </p>
<p>(safety) </p></td>
<td style="text-align: left;"><p>Inject subcutaneously at least 500 Lf
of purified toxoid in a volume of 1 ml into each of five </p>
<p>healthy guinea pigs, each weighing 250 to 350 g, that have not
previously been treated with any material that will interfere </p>
<p>with the test. </p></td>
...
<tr>
<td style="text-align: left;"><p>Irreversibility of toxin </p>
<p>(safety) </p></td>
<td style="text-align: left;"><p>Using the buffer for the final vaccine
(without adjuvant), prepare a dilution of the bulk purified </p>
<p>toxoid containing the same toxoid concentration as the final vaccine.
Divide the dilution into two equal parts. Keep one of </p>
<p>them at 2° to 8° and the other at 34° to 37° for 6 weeks. Test both
dilutions by injecting 5 ml of incubated samples </p>
<p>subcutaneously to 5 guinea pigs weighing 250 g to 350 g that have not
previously treated with any material that will interfere </p>
<p>with the test and observe the animals for 21 days </p></td>
...
<td style="text-align: left;">Challenge assay in mice </td>
<td style="text-align: left;"><p>RFFID / SRID (bulk and final lot -&gt;
but accepted as release in some cases  </p>
<p> </p>
<p>ELISA </p></td>
<td style="text-align: left;"><p> </p>
<p> </p>
...
<p> </p>
<p> </p>
<p>Alternative method in Eu Ph (compendial status planned from 2026
onward) </p></td>
</tr>
<tr>
...
<td style="text-align: left;"><p>In vitro potency for the individual
components:  </p>
<p>Serology </p>
<p> </p></td>
...
India </td>
<td><ul>
<li><p>Work with the companies to understand specific challenges to
implement this and enable dialogue with regulators </p></li>
</ul></td>
</tr>
<tr>
...
India </td>
<td><ul>
<li><p>Identify vaccine companies who may prioritise this test in their
internal portfolio </p></li>
</ul>
<ul>
<li><p>Work with the companies to understand product- specific
challenges and enable dialogue with regulators </p></li>
</ul></td>
</tr>
<tr>
...
and antibodies  </td>
<td style="text-align: left;">1-3 years </td>
<td style="text-align: left;"><p>This would require working with global
government and funding bodies to ensure smooth supply chain for critical
reagents </p>
<p> </p>
<p>Compile a database of critical reagents required for the methods
documented in this chapter and resources/companies/global bodies  from
where they could be sourced to India. </p></td>
</tr>
<tr>
...
<td style="text-align: left;"><p>If required, accelerate and enable the
...
and provide a forum to share data, experience, challenges.  </p>
<p> </p></td>
</tr>
</tbody>
</table>
...
<img src="./media/image10.png" style="width:6.26772in;height:2.31944in"
...
<img src="./media/image11.png" style="width:6.61263in;height:3.19647in"
alt="A diagram of a drug development sector AI-generated content may be incorrect." />
...
<img src="./media/image12.png" style="width:7.55208in;height:5.19516in"
alt="A diagram of a company AI-generated content may be incorrect." />
...
<img src="./media/image20.jpg" style="width:5.79114in;height:4.33854in"
alt="A diagram of a hub AI-generated content may be incorrect." />
...
5.  <span class="mark">Encourage adoption and development of NAMs by
    ...
    Australia.</span>[^18] <span class="mark">Programmes like the
    National Tech Startup Policy under the</span> Office of the
    Principal Scientific Advisor can be leveraged to provide a robust
    starting point to encourage CROs in adopting NAMs.

6.  <span class="mark">Identify labs that have the potential to develop
    ...
    partnerships and providing funding.</span>
...
<img src="./media/image13.png" style="width:6.26772in;height:3.26389in"
alt="A diagram of a company AI-generated content may be incorrect." />
...
[^2]: National Toxicology Program, U.S. Department of Health and Human
    ...
    <span class="mark">accessed 7 February 2025.</span>
...
[^14]: Emulate ‘FDA Signs Collaborative Agreement with Emulate, Inc. to
    ...
    <span class="mark">accessed 12 February 2025</span>
...
[^16]: <span class="mark">IQMPS ‘Background’ \< https://www.iqmps.org/\>
    accessed 11 February 2025</span>
...
[^19]: <span class="mark">Ahmed SM, Shivnaraine RV, Wu JC. ‘FDA
    Modernization Act 2.0 Paves the Way to Computational Biology and
    Clinical Trials in a Dish’ (2023) \<doi:
    10.1161/CIRCULATIONAHA.123.065585.\></span> accessed 11 February
    2025.
